...
<div class="mx-auto max-w-5xl space-y-6">
    ...
    <div class="relative overflow-hidden rounded-3xl border border-amber-200/80 bg-gradient-to-b from-amber-50/60 via-white to-amber-50/30 p-8 sm:p-12 text-center shadow-sm">
        ...
        <h2 class="text-2xl sm:text-3xl font-black text-[#231a3d] mt-4 tracking-tight">
            Modul Analitik &amp; Laporan Bisnis
        </h2>

        <p class="mt-3 text-sm text-[#6e6584] leading-relaxed max-w-lg mx-auto">
            Fitur analitik performa, grafik tren pendapatan, dan tingkat konversi pelanggan saat ini sedang dipersiapkan dan akan segera diluncurkan pada pembaruan mendatang.
        </p>
        ...
        <div class="mt-6 flex flex-wrap items-center justify-center gap-3">
            ...
            <a href="{{ route('owner.bookings') }}" class="craft-btn inline-flex items-center gap-2 rounded-xl border border-[#e7e2f7] bg-white px-5 py-2.5 text-xs font-bold text-[#231a3d] hover:bg-[#f7f7fa] shadow-2xs transition">
                <span>Lihat Data Bookings</span>
            </a>
        </div>
        ...
        <div class="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 opacity-40 filter blur-[1px] pointer-events-none select-none">
            <div class="rounded-2xl border border-[#e7e2f7] bg-white p-4 text-left">
                <p class="text-[11px] font-bold text-[#6e6584] uppercase">Estimasi Revenue</p>
                <p class="text-xl font-black text-[#231a3d] mt-1">Rp ••••••••</p>
                <div class="mt-2 h-1.5 w-3/4 rounded-full bg-slate-200"></div>
            </div>
            <div class="rounded-2xl border border-[#e7e2f7] bg-white p-4 text-left">
                <p class="text-[11px] font-bold text-[#6e6584] uppercase">Tingkat Konversi</p>
                <p class="text-xl font-black text-[#231a3d] mt-1">••%</p>
                <div class="mt-2 h-1.5 w-1/2 rounded-full bg-slate-200"></div>
            </div>
            <div class="rounded-2xl border border-[#e7e2f7] bg-white p-4 text-left">
                <p class="text-[11px] font-bold text-[#6e6584] uppercase">Volume Transaksi</p>
                <p class="text-xl font-black text-[#231a3d] mt-1">•• Booking</p>

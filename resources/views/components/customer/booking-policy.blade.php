<div class="booking-policy rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] p-4 sm:p-5">
    <div class="flex items-start gap-3.5">
        <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#EEF2FF] text-[#4F46E5]">

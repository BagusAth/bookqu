...
<div class="flex flex-col gap-3 rounded-xl border border-[#C7D2FE] bg-gradient-to-r from-[#EEF2FF] to-indigo-100/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between" id="trial-banner">
    <div class="flex items-center gap-3">
        <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#4F46E5] text-white shadow-sm shadow-[#4F46E5]/25">
            <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
            </svg>
        </div>
        <p class="text-sm font-medium text-[#312E81]">
